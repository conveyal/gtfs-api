...
//            )
    ...
    public static final GraphQLObjectType routeType = newObject().name("route")
            ...
            .field(newFieldDefinition()
                    ...
                    .name("stops")
                    .dataFetcher(StopFetcher::fromRoute)
                    .build()
            )
            .field(RowCountFetcher.field("count", "routes"))
            .field(newFieldDefinition()
		            .name("trip_count")
		            .description("The number of trips defined for the route")
		            .type(GraphQLInt)
		            .dataFetcher(new RowCountFilteredFetcher("trips", "route_id"))
		            .build()
            )
            .field(newFieldDefinition()
		            .name("pattern_count")
		            .description("The number of patterns defined for the route")
		            .type(GraphQLInt)
...
//            )
            ...
            .field(newFieldDefinition()
		            .name("route_count")
		            .description("The number of routes that serve a stop")
		            .type(GraphQLInt)
		            .dataFetcher(RouteFetcher::fromStopCount)
		            .build()
            )
            .build();
    ...
    public static GraphQLObjectType patternType = newObject().name("pattern")
            ...
            .field(newFieldDefinition()
              .name("stop_count")
              .description("The number of stops served by the pattern")
              .type(GraphQLInt)
              .dataFetcher(new RowCountFilteredFetcher("pattern_stops", "pattern_id"))
              .build()
            )
            .field(newFieldDefinition()
              .name("trip_count")
              .description("The number of trips defined for the pattern")
              .type(GraphQLInt)
              .dataFetcher(new RowCountFilteredFetcher("trips", "pattern_id"))
              .build()
            )
            .build();
