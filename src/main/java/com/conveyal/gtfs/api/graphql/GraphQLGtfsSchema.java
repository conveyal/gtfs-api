...
public class GraphQLGtfsSchema {
    ...
    public static GraphQLObjectType rootQuery = newObject()
            ...
            .field(newFieldDefinition()
                    ...
                    .argument(multiStringArg("feed_id"))
                    .argument(multiStringArg("stop_id"))
                    .argument(stringArg("lat"))
                    .argument(stringArg("lng"))
                    .argument(stringArg("radius"))
                    .argument(stringArg("max_lat"))
                    .argument(stringArg("max_lon"))
                    .argument(stringArg("min_lat"))
                    .argument(stringArg("min_lon"))
